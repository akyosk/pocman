...
from cve.Spring.SBSCAN_master.scanners.path_detector import PathDetector
from cve.Spring.SBSCAN_master.scanners.cve_scanner import CVEScanner
from cve.Spring.SBSCAN_master.scanners.fingerprint_detector import FingerprintDetector
from cve.Spring.SBSCAN_master.managers.concurrency_manager import ConcurrencyManager
from cve.Spring.SBSCAN_master.utils.config_loader import ConfigLoader
from cve.Spring.SBSCAN_master.utils.reporter import ReportGenerator
...
class ScannerManager:
    def __init__(self, target_urls, proxy_manager, dns_domain, max_threads, fingerprint_filter=False, quiet=False):
        ...
        # 创建Path扫描器的实例
        paths_config = ConfigLoader.load_config("./cve/Spring/SBSCAN_master/config/path.json")
        self.path_detector = PathDetector(paths_config, self.proxy_manager)

        # 创建CVE扫描器的实例
        cve_config = ConfigLoader.load_config("./cve/Spring/SBSCAN_master/config/cve.json") or {}
