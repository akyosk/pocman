    ...
    def run(self, urls):
        try:
            ...
            if "disable_functions" in response.text:
                ...
                with open("./result/thinkphpRceAll.txt","a") as w:
    ...
    def run5(self, urls):
        try:
            ...
            if response.status_code== 200 and url == response.url:
                ...
                OutPrintInfo("ThinkPHP", f"DATA:{data}\n")
                with open("./result/thinkphpRceAll.txt","a") as w:
                    w.write(f"可能存在ThinkPHP-5.0.10-RCE-POC-1 {url} --- Data {data}\n")
            else:
                pass
    ...
    def run19(self, urls):
        try:
            ...
            if "disable_functions" in response.text:
                ...
                OutPrintInfo("ThinkPHP", f"{url}\n")
                with open("./result/thinkphpRceAll.txt","a") as w:
                    w.write(f"存在ThinkPHP-5.0.18-RCE-POC-2 {url}\n")
                # # OutPrintInfo("ThinkPHP", f"SHELL {url2}")
            # # OutPrintInfo("ThinkPHP", f"DATA:{data}")
            else:
                pass
    ...
    def run23(self, urls):
        try:
            ...
            if "disable_functions" in response.text:
                ...
                OutPrintInfo("ThinkPHP", f"DATA:{data}\n")
                with open("./result/thinkphpRceAll.txt","a") as w:
                    w.write(f"存在ThinkPHP-5.0.8-RCE-POC-1 {url} --- Data {data}\n")
            else:
                pass
    ...
    def run25(self, urls):
        try:
            ...
            if "disable_functions" in response2.text:
                ...
                OutPrintInfo("ThinkPHP", f"{url}\n")
                with open("./result/thinkphpRceAll.txt","a") as w:
                    w.write(f"存在ThinkPHP-5.0.8-RCE-POC-3 {url}\n")
                # # OutPrintInfo("ThinkPHP", f"DATA:{data}")
                # OutPrintInfo("ThinkPHP", f"SHELL {url2}")
