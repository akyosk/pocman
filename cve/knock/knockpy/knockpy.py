...
_params = {
    ...
    "output_folder": "./result/knockpy_report",      # [str] report folder -o /folder/
...
class Start():
    ...
    def arguments():
        ...
        description += "* REPORT\n"
        description += "show report:\tknockpy --report ./result/knockpy_report/domain.com_yyyy_mm_dd_hh_mm_ss.json\n"
        description += "plot report:\tknockpy --plot ./result/knockpy_report/domain.com_yyyy_mm_dd_hh_mm_ss.json\n"
        description += "csv report:\tknockpy --csv ./result/knockpy_report/domain.com_yyyy_mm_dd_hh_mm_ss.json\n"
        description += "-"*80
