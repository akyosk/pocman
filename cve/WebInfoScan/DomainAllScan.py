...
shodan_api = config_yaml_values['shodan_api']
virustotal_api = config_yaml_values['virustotal_api']
dnsdump_csrftoken = config_yaml_values['dnsdump_csrftoken']
fofa_email = config_yaml_values['fofa_email']
fofa_key = config_yaml_values['fofa_key']
yt_key = config_yaml_values['yt_key']
viewdns_key = config_yaml_values['viewdns_key']
fullhunt_api = config_yaml_values['fullhunt_api']
zoomeye_key = config_yaml_values['zoomeye_key']
