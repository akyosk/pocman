...
class JsFinderScan:
    ...
    def find_by_url(self,url, js=False):
        if js == False:
            ...
            if html_raw == None:
                OutPrintInfo("JsFinder",f"无法访问[b bright_red]{url}[/b bright_red]")
                return None
            # print(html_raw)
    ...
    def find_by_url_deep(self,url):
        ...
        for link in links:
            ...
            OutPrintInfo("JsFinder",f"从[b bright_red]{str(i)}[/b bright_red]个结果中找到[b bright_red]{str(len(temp_urls))}[/b bright_red]个URL在[b bright_red]{link}[/b bright_red]")
            for temp_url in temp_urls:
    ...
    def giveresult(self,urls, domian):
        ...
        for subdomain in subdomains:
            ...
            OutPrintInfo("JsFinder-Subdomain",f"[b bright_red]{subdomain}[/b bright_red]")
        if urls:
