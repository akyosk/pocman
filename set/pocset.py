...
from cve.Wordpress.Wholesale_File_Read import Wholesale_File_Read_Scan
...
from cve.ThinkPHP.Thinkphp_Log_Rce import Thinkphp_Log_Rce_Scan
...
from cve.Weblogic.weblogicScanner_master.weblogicRun import weblogicRunScan
from cve.Weblogic.CVE_2017_10271 import Cve_2017_10271
from cve.Weblogic.CVE_2019_2725 import Cve_2019_2725
...
modules = [
    ...
    {"name": "WordPress", "description": "WordPress Wholesale[b bright_red]任意文件[/b bright_red]读取漏洞", "params": {"url": url,"ssl": ssl,"header":ua,"proxy":proxy,"batch_work":False,"fofa":'body="wp-content/plugins/wholesale-market"'},"attack":"wp-",'poc': Wholesale_File_Read_Scan},
    ...
    {"name": "ThinkPHP", "description": "[b bright_red]ThinkPHP[/b bright_red] 3.x/5.x全版本RCE扫描","params": {"url": url,"ssl": ssl,"header": ua,"proxy": proxy, "timeout": timeout,"batch_work":False},"attack":"Think", 'poc': ThinkRCEScan},
    {"name": "ThinkPHP", "description": "[b bright_red]ThinkPHP[/b bright_red] 日志包含扫描","params": {"url": url,"ssl": ssl,"header": ua,"proxy": proxy, "timeout": timeout,"batch_work":False},"attack":"Think", 'poc': Thinkphp_Log_Rce_Scan},
    ...
    {"name": "WebLogic", "description": "WebLogic漏洞[b bright_red]weblogicScaner[/b bright_red]工具移植","params": {"ip": ip}, 'poc': weblogicRunScan},
    {"name": "WebLogic", "description": "WebLogic XMLDecoder[b bright_red]CVE-2017-10271[/b bright_red]反序列化漏洞", "params": {"url": url,"header":ua,"proxy":proxy,"ssl":ssl,"batch_work":False},"attack":"weblogic",'poc': Cve_2017_10271},
    {"name": "WebLogic", "description": "WebLogic wls-wsat[b bright_red]CVE-2019-2725[/b bright_red]反序列化漏洞", "params": {"url": url,"header":ua,"proxy":proxy,"ssl":ssl,"batch_work":False},"attack":"weblogic",'poc': Cve_2019_2725},
